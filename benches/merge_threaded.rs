...
fn merge_sort_threaded_10(c: &mut Criterion) {
    ...
    c.bench_function("merge sort multithreaded 10", |b| b.iter(|| merge_sort_multithreaded(&mut numbers.clone())));
}
...
fn merge_sort_threaded_100(c: &mut Criterion) {
    ...
    c.bench_function("merge sort multithreaded 100", |b| b.iter(|| merge_sort_multithreaded(&mut numbers.clone())));
}
...
fn merge_sort_threaded_1k(c: &mut Criterion) {
    ...
    c.bench_function("merge sort multithreaded 1k", |b| b.iter(|| merge_sort_multithreaded(&mut numbers.clone())));
}
...
fn merge_sort_threaded_10k(c: &mut Criterion) {
    ...
    c.bench_function("merge sort multithreaded 10k", |b| b.iter(|| merge_sort_multithreaded(&mut numbers.clone())));
}
...
fn merge_sort_threaded_100k(c: &mut Criterion) {
    ...
    c.bench_function("merge sort multithreaded 100k", |b| b.iter(|| merge_sort_multithreaded(&mut numbers.clone())));
}
...
fn merge_sort_threaded_1m(c: &mut Criterion) {
    ...
    c.bench_function("merge sort multithreaded 1M", |b| b.iter(|| merge_sort_multithreaded(&mut numbers.clone())));
}
